...
function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
  // Using proper types for Rapier refs
            ...
            onPointerDown={(e: any) => {
              ...
              drag(
                new THREE.Vector3()
                  .copy(e.point)
                  .sub(
                    vec.copy(card.current?.translation() || new THREE.Vector3())
                  )
              );
            }}
          >
